/*. Escribir un programa que lea N, M y la matriz desde un archivo de texto DATOS.TXT, y luego mediante un
menú repetitivo invoque a la función correspondiente (desarrolladas en el ejercicio anterior) mostrando el
resultado.*/
#include <stdio.h>
#define MAXFILAS 100
...
int main() {
    ...
    FILE *archivo=fopen("Ejercicio30.txt","r");
